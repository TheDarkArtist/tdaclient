...
export function ArticleCard({ data }: { data: Article }) {
  return (
    <div className="inter-va h-full relative">
      <div className="bg-white relative cursor-pointer group/card  dark:hover:shadow-2xl dark:hover:shadow-cyan-500/[0.1] bg-grid-cyan-600/[.2] dark:bg-grid-cyan-600/[.2] dark:bg-black dark:border-white/[0.2] border-stone-600/[0.2] h-full w-full rounded-xl md:px-6 md:pt-10 p-3 border  hover:scale-[1.02] transition-all ease-in-out duration-200">
        <div
